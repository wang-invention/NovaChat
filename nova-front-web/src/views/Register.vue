        ...
        <form class="auth-form" @submit.prevent="handleRegister">
          <div class="form-group">
            ...
            <div class="input-wrap">
              ...
              <input v-model="form.username" type="text" class="form-input" placeholder="请输入用户名" maxlength="32">
            </div>
          ...
          <div class="form-group">
            ...
            <span class="form-error">{{ errors.nickname }}</span>
          </div>
          <div class="form-group">
            ...
            <div class="input-wrap">
              ...
              <input v-model="form.password" :type="showPwd ? 'text' : 'password'" class="form-input" placeholder="请输入密码" maxlength="32">
...
async function handleRegister() {
  ...
  if (form.password.length < 6) { errors.password = '密码至少6位'; valid = false }
  if (!valid) return

  loading.value = true
  try {
    const res = await register({ username: form.username, nickname: form.nickname, password: form.password })
